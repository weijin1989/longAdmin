<template>
  <div class="app-container voyager">
    <div class="container-fluid">
      <h1 class="page-title"><i class="el-icon-document" /> 添加文章</h1>
    </div>
                ...
                >
                  <el-row class="row-box">
                    ...
                    <el-col :span="8" class="row-left">
                      ...
                      >&nbsp;&nbsp;&nbsp;
                      <img v-if="item.url_path" :src="item.url_path+'?'+Math.ceil(Math.random()*10)" style="width:50px;background:#d5d5d5;border:1px solid #000">
                    </el-col>
                    <el-col :span="3">
                      <el-row
        ...
        uploadImg(params)
          .then((data) => {
            ...
            img.onload = function() {
              ...
              that.batchForm[index].url_path = data.data.url
              that.loading.close()
            }
          })
          .catch((error) => {
